...
from MyLLM import geminiTxt, progressBar, save_uploadedfile, makeAudio, openAiModel, encode_image, save_carpturefile
...
if picture:
    ...
    if st.button("SEND"):
        base64img = encode_image("capture/"+picture.name)
        model = openAiModel()
